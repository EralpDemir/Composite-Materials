...
elseif strcmp(eltyp, 'HCT')
    
    
    
elseif strcmp(eltyp, 'REC')
...
elseif strcmp(eltyp, 'BFS+LAG')
    ...
    N(3,3) = (e^3*k^3)/16 - (3*e^3*k)/16 + e^3/8 - (3*e*k^3)/16 + (9*e*k)/16 - (3*e)/8 + k^3/8 - (3*k)/8 + 1/4;
    N(3,4) = -a*(- (e^3*k^3)/16 + (e^3*k^2)/16 + (e^3*k)/16 - e^3/16 + (3*e*k^3)/16 - (3*e*k^2)/16 - (3*e*k)/16 + (3*e)/16 - k^3/8 + k^2/8 + k/8 - 1/8);
    N(3,5) = -b*(- (e^3*k^3)/16 + (3*e^3*k)/16 - e^3/8 + (e^2*k^3)/16 - (3*e^2*k)/16 + e^2/8 + (e*k^3)/16 - (3*e*k)/16 + e/8 - k^3/16 + (3*k)/16 - 1/8);
    N(3,6) = -a*b*(- (e^3*k^3)/16 + (e^3*k^2)/16 + (e^3*k)/16 - e^3/16 + (e^2*k^3)/16 - (e^2*k^2)/16 - (e^2*k)/16 + e^2/16 + (e*k^3)/16 - (e*k^2)/16 - (e*k)/16 + e/16 - k^3/16 + k^2/16 + k/16 - 1/16);
    
    N(3,9) = - (e^3*k^3)/16 + (3*e^3*k)/16 + e^3/8 + (3*e*k^3)/16 - (9*e*k)/16 - (3*e)/8 - k^3/8 + (3*k)/8 + 1/4;
    N(3,10) = a*((e^3*k^3)/16 + (e^3*k^2)/16 - (e^3*k)/16 - e^3/16 - (3*e*k^3)/16 - (3*e*k^2)/16 + (3*e*k)/16 + (3*e)/16 + k^3/8 + k^2/8 - k/8 - 1/8);
    N(3,11) = -b*((e^3*k^3)/16 - (3*e^3*k)/16 - e^3/8 - (e^2*k^3)/16 + (3*e^2*k)/16 + e^2/8 - (e*k^3)/16 + (3*e*k)/16 + e/8 + k^3/16 - (3*k)/16 - 1/8);
    N(3,12) = a*b*((e^3*k^3)/16 + (e^3*k^2)/16 - (e^3*k)/16 - e^3/16 - (e^2*k^3)/16 - (e^2*k^2)/16 + (e^2*k)/16 + e^2/16 - (e*k^3)/16 - (e*k^2)/16 + (e*k)/16 + e/16 + k^3/16 + k^2/16 - k/16 - 1/16);
    
    N(3,15) = (e^3*k^3)/16 - (3*e^3*k)/16 - e^3/8 - (3*e*k^3)/16 + (9*e*k)/16 + (3*e)/8 - k^3/8 + (3*k)/8 + 1/4;
    N(3,16) = -a*((e^3*k^3)/16 + (e^3*k^2)/16 - (e^3*k)/16 - e^3/16 - (3*e*k^3)/16 - (3*e*k^2)/16 + (3*e*k)/16 + (3*e)/16 - k^3/8 - k^2/8 + k/8 + 1/8);
    N(3,17) = -b*((e^3*k^3)/16 - (3*e^3*k)/16 - e^3/8 + (e^2*k^3)/16 - (3*e^2*k)/16 - e^2/8 - (e*k^3)/16 + (3*e*k)/16 + e/8 - k^3/16 + (3*k)/16 + 1/8);
    N(3,18) = a*b*((e^3*k^3)/16 + (e^3*k^2)/16 - (e^3*k)/16 - e^3/16 + (e^2*k^3)/16 + (e^2*k^2)/16 - (e^2*k)/16 - e^2/16 - (e*k^3)/16 - (e*k^2)/16 + (e*k)/16 + e/16 - k^3/16 - k^2/16 + k/16 + 1/16);
    
    N(3,21) = - (e^3*k^3)/16 + (3*e^3*k)/16 - e^3/8 + (3*e*k^3)/16 - (9*e*k)/16 + (3*e)/8 + k^3/8 - (3*k)/8 + 1/4;
    N(3,22) = a*(- (e^3*k^3)/16 + (e^3*k^2)/16 + (e^3*k)/16 - e^3/16 + (3*e*k^3)/16 - (3*e*k^2)/16 - (3*e*k)/16 + (3*e)/16 + k^3/8 - k^2/8 - k/8 + 1/8);
    N(3,23) = -b*(- (e^3*k^3)/16 + (3*e^3*k)/16 - e^3/8 - (e^2*k^3)/16 + (3*e^2*k)/16 - e^2/8 + (e*k^3)/16 - (3*e*k)/16 + e/8 + k^3/16 - (3*k)/16 + 1/8);
    N(3,24) = -a*b*(- (e^3*k^3)/16 + (e^3*k^2)/16 + (e^3*k)/16 - e^3/16 - (e^2*k^3)/16 + (e^2*k^2)/16 + (e^2*k)/16 - e^2/16 + (e*k^3)/16 - (e*k^2)/16 - (e*k)/16 + e/16 + k^3/16 - k^2/16 - k/16 + 1/16);
