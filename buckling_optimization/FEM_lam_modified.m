...
function [R_m_bottom, lambda, a, di, mK_m, nKg] = FEM_lam_modified(numel, nnpe, dof_b, dof_m, ...
    conn, crds, angPly, nPly, zPly, t, U, dofBCs_b, dofBCs_m, valdofs_b, valdofs_m, ...
...
for iele = 1:1:numel
    ...
    [A, B, D] = MAT_stiffness(nPly, angPly(iele,:),zz , t, U);
